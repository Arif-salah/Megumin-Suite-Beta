export const hardcodedLogic = {
  modes: [
    {
      id: "v9-core", label: "V9 Shinjitsu", color: "#f43f5e", isNew: true, isV9: true, recommended: true,
    ...
    {
      id: "v9-lite", label: "V9 Xin", color: "#f43f5e", isNew: true, isV9: true,
...
5d_pacing_final: "Check the word count against your pacing decision from 1d. Early RP and you wrote 300 words? Wrong — go back and render the world. Established world and you wrote 900 words of a simple dialogue beat? Too much — trim. The pacing decision is not a suggestion. It's the rule."
